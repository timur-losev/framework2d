...
${OBJECTDIR}/wxIrrlichtTest.o: wxIrrlichtTest.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/wxIrrlichtTest.o wxIrrlichtTest.cpp

${OBJECTDIR}/wxIrrlichtCanvas.o: wxIrrlichtCanvas.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/wxIrrlichtCanvas.o wxIrrlichtCanvas.cpp
