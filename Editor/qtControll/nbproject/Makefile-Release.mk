...
${OBJECTDIR}/moc_MainWindow.o: moc_MainWindow.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/moc_MainWindow.o moc_MainWindow.cpp

${OBJECTDIR}/moc_QIrrControl.o: moc_QIrrControl.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/moc_QIrrControl.o moc_QIrrControl.cpp

${OBJECTDIR}/QIrrControl.o: QIrrControl.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/QIrrControl.o QIrrControl.cpp
