...
ECOLOR_FORMAT COGLES1Texture::getBestColorFormat(ECOLOR_FORMAT format)
{
	...
	switch (format)
	{
...
#ifndef _IRR_COMPILE_WITH_PVR_LOADER_
		case ECF_R5G6B5:
			if (!Driver->getTextureCreationFlag(ETCF_ALWAYS_32_BIT))
				destFormat = ECF_A1R5G5B5;
		break;
		...
		break;
#endif
        //Ignoring all creation flags
        case ECF_COMPRESSED_RGB_PVRTC_2BPP:
        case ECF_COMPRESSED_RGB_PVRTC_4BPP:
        case ECF_COMPRESSED_RGB_PVRTCII_2BPP:
        case ECF_COMPRESSED_RGB_PVRTCII_4BPP:
        case ECF_COMPRESSED_RGBA_PVRTC_2BPP:
        case ECF_COMPRESSED_RGBA_PVRTC_4BPP:
        case ECF_COMPRESSED_RGBA_PVRTCII_2BPP:
        case ECF_COMPRESSED_RGBA_PVRTCII_4BPP:
        case ECF_R5G5B5A1:
        case ECF_R8G8B8A8:
        case ECF_R4G4B4A4:
        case ECF_R8G8B8:
...
void COGLES1Texture::uploadTexture(bool newTexture, void* mipmapData, u32 level)
{
	...
	if (!level && newTexture)
	{
		...
		#else
			HasMipMaps=false;
			os::Printer::log("Did not create OGLES1 texture mip maps.", ELL_INFORMATION);
		#endif
		{
