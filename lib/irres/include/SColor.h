...
namespace video
{
    ...
    enum ECOLOR_FORMAT
    {
        ...
        // ETC formats
        ECF_COMPRESSED_ETC1_RGB8,
        ECF_COMPRESSED_ETC1_RGB8_NATIVE_DMP,
        ECF_COMPRESSED_ETC1_ALPHA_RGB8_A4_NATIVE_DMP,

        // ATC formats
        ECF_COMPRESSED_ATC_RGB,
        ECF_COMPRESSED_ATC_RGBA_EXPLICIT_ALPHA,
        ECF_COMPRESSED_ATC_RGBA_INTERPOLATED_ALPHA,

        // 3DC formats
        ECF_COMPRESSED_3DC_X,
        ECF_COMPRESSED_3DC_XY,
