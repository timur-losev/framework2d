 ...
 * Platform     : ANSI
 *
 * $Date: 2010/10/05 14:57:16 $ $Revision: 1.1 $
 * $Log: ews_types.h,v $
 * Revision 1.1  2010/10/05 14:57:16  sbm
 * [INTERNAL BUILDS]
 * - Checking in the EWS headers.
 *
 ******************************************************************************/
...
typedef enum
{
	...
	EWS_PIXEL_FORMAT_XBGR_8888 = 6,
} EWS_PIXELFORMAT;

#define EWS_PIXEL_FORMAT_MAX EWS_PIXEL_FORMAT_XBGR_8888
...
/* The number of buffers that are allocated by the server for each client */
#define EWS_CLIENT_NUM_BUFFERS 2
